...
def getBiomarkerMatcher():
    with open(root + 'databases/markerData.pickle', 'rb') as f:
...
def getUnitsMatcher():
    ...
    units_dm = DictionaryMatch(d=unitsDatabase, ignore_case=False)
...
def getDiseaseMatcher():
    with open(root + 'databases/diseaseAbbreviationsDatabase.pickle', 'rb') as f:
        diseaseAbb = pickle.load(f)

    with open(root + 'databases/diseaseDatabase.pickle', 'rb') as f:
...
def getDrugAssociationMatcher():
    with open(root + 'databases/drugDatabase.pickle', 'rb') as f:
...
def getMediumMatcher():
    with open(root + 'databases/mediumDatabase.pickle', 'rb') as f:
...
def getBiomarkerTypeMatcher():
    with open(root + 'databases/typesDatabase.pickle', 'rb') as f:
